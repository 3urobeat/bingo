...
<template>
    <div class="flex flex-col h-screen w-screen bg-gradient-to-br from-gray-400 via-gray-500 to-gray-600">
        ...
        <div class="absolute bottom-2 self-center text-center text-black">
            ...
            <br />
            <button type="button" @click="clickGithub" class="bottom-0 right-0 rounded-full px-2 text-gray-400 bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2">
