 ...
 * Author: 3urobeat
 * 
 * Last Modified: 29.07.2023 22:33:54
...
<template>
    <div class="flex flex-col h-screen w-screen bg-gradient-to-br from-gray-400 via-gray-500 to-gray-600">
        ...
        <div class="absolute bottom-2 self-center flex flex-col items-center text-black">
            Bingo v{{ packagejson.version }}

            <button type="button" @click="clickGithub" class="mt-1 rounded-full px-2 text-gray-400 bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 self-center text-center flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30">
                ...
                <span class="text-gray-400 rounded-lg" href="https://github.com/3urobeat/bingo" target="_blank">Source Code</span>
            </button>
