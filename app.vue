 ...
 * Author: 3urobeat
 *
 * Last Modified: 2024-03-25 17:41:06
...
<template>
    ...
    <div class="flex flex-col items-center justify-between h-screen w-screen overflow-y-hidden bg-gradient-to-br from-gray-400 via-gray-500 to-gray-600">
        ...
        <footer class="self-center flex flex-col items-center mb-2 text-xs md:text-sm text-gray-900">
            Bingo v{{ packagejson.version }}

            <button type="button" @click="clickGithub" class="mt-1 rounded-full px-2 text-gray-400 bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 text-center flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 bg-opacity-80">
