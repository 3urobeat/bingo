...
<template>
    <div class="flex flex-col h-screen w-screen bg-gray-400">
        ...
        <div class="absolute bottom-2 self-center text-center text-gray-400">
            <a class="bottom-0 hover:text-gray-500 rounded-l" href="https://github.com/3urobeat/bingo" target="_blank">Bingo v{{ packagejson.version }}</a>
            <br />
            <button type="button" @click="clickGithub" class="bottom-0 right-0 w-5 h-5 rounded-full bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2">
            ...
            <a class="hover:text-gray-500 rounded-l" href="https://github.com/3urobeat/bingo" target="_blank">Source Code</a>
            <br />
